...
var K = s((n) => {
  if (!n || n.type === "error") return { type: "error", error: n && n.type === "error" && n.error || "Handled by outer wallet." };
  if (n.type === "success") return { type: "success", response: n.value };
...
var F = class F2 {
  ...
  static listen(t) {
    let { iframe: e, target: r, getOfflineSignerDirect: c, getOfflineSignerAmino: h, nonSignerOverrides: I, signerOverrides: l, origins: f2, metadata: _ } = t, E = (f2 == null ? void 0 : f2.length) ? f2 : ["*"], k = { [w.IsCosmiframe]: () => true, [w.GetMetadata]: () => _ || null }, H = s(async ({ source: Q, origin: q, data: y }) => {
      ...
      if (Q !== e.contentWindow || !U(E, q) || !y || typeof y != "object" || !("id" in y) || !("method" in y) || !("params" in y)) return;
      let { id: V, params: S, chainId: L, signType: X, internal: Z } = y, { method: i, signerType: N } = y;
      N || (N = X), i = i.replace(/^signer:/, "");
      let d;
      try {
        if (Z) {
          if (typeof k[i] != "function") throw new Error(`Unknown internal method: ${i}`);
          d = { type: "success", response: await k[i](...S) };
        } else if (N) {
          if (!L) throw new Error("Missing chainId in signer message request");
          ...
          if (!d) {
            ...
            if (!(i in g) || typeof g[i] != "function") throw new Error(`No ${N} signer method '${i}' for chain ID '${L}'.`);
          ...
          if (!d) {
            if (!(i in r) || typeof r[i] != "function") throw new Error(`No method '${i}' on target.`);
...
// ../../node_modules/.pnpm/@cosmos-kit+core@2.16.1/node_modules/@cosmos-kit/core/esm/bases/index.js
init_process();
init_buffer();
...
var ChainWalletBase = class extends WalletBase {
  constructor(walletInfo, chainRecord) {
    ...
    __publicField(this, "getRpcEndpoint", async (isLazy) => {
      var _a;
      const { getIsLazy } = await import("./utils-XID6D7NY.js");
      ...
      const nodeType = "rpc";
      const { isValidEndpoint } = await import("./utils-XID6D7NY.js");
      if (this._rpcEndpoint && await isValidEndpoint(this._rpcEndpoint, nodeType, lazy, this.logger)) {
        return this._rpcEndpoint;
      }
      const { getFastestEndpoint } = await import("./utils-XID6D7NY.js");
    ...
    __publicField(this, "getSigningStargateClient", async () => {
      ...
      const { SigningStargateClient } = await import("./build-LFXD3O2R.js");
    ...
    __publicField(this, "getSigningCosmWasmClient", async () => {
      ...
      const { SigningCosmWasmClient } = await import("./build-RKZTAXL2.js");
    ...
    __publicField(this, "estimateFee", async (messages, type, memo, multiplier) => {
      ...
      const { calculateFee } = await import("./build-LFXD3O2R.js");
    ...
    __publicField(this, "broadcast", async (signedMessages, type) => {
      ...
      const client = await this.getSigningClient(type);
      const { TxRaw } = await import("./tx-BNDTKURS.js");
...
// ../../node_modules/.pnpm/@cosmos-kit+core@2.16.1/node_modules/@cosmos-kit/core/esm/cosmiframe/index.js
init_process();
init_buffer();
...
// ../../node_modules/.pnpm/@cosmos-kit+core@2.16.1/node_modules/@cosmos-kit/core/esm/cosmiframe/extension/index.js
init_process();
init_buffer();
...
// ../../node_modules/.pnpm/@chain-registry+client@1.53.174/node_modules/@chain-registry/client/esm/index.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+client@1.53.174/node_modules/@chain-registry/client/esm/chain-info.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+utils@1.51.174/node_modules/@chain-registry/utils/esm/index.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+utils@1.51.174/node_modules/@chain-registry/utils/esm/assets.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+utils@1.51.174/node_modules/@chain-registry/utils/esm/utils.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+utils@1.51.174/node_modules/@chain-registry/utils/esm/calc.js
init_process();
init_buffer();
...
// ../../node_modules/.pnpm/@chain-registry+utils@1.51.174/node_modules/@chain-registry/utils/esm/chains.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+utils@1.51.174/node_modules/@chain-registry/utils/esm/ibc.js
init_process();
init_buffer();
...
// ../../node_modules/.pnpm/@chain-registry+client@1.53.174/node_modules/@chain-registry/client/esm/chain-util.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/@chain-registry+client@1.53.174/node_modules/@chain-registry/client/esm/fetcher.js
init_process();
init_buffer();

// ../../node_modules/.pnpm/bfs-path@1.0.2/node_modules/bfs-path/js/es6/path.js
init_process();
init_buffer();
...
// ../../node_modules/.pnpm/@chain-registry+client@1.53.174/node_modules/@chain-registry/client/esm/registry.js
init_process();
init_buffer();
  ...
  constructor(chains, wallets, logger, throwErrors, subscribeConnectEvents = true, allowedCosmiframeParentOrigins = [
    ...
    __publicField(this, "getNameService", async (chainName) => {
      ...
      if (!chainName) {
        ...
        const { getNameServiceRegistryFromName } = await import("./utils-XID6D7NY.js");
...
// ../../node_modules/.pnpm/@cosmos-kit+core@2.16.1/node_modules/@cosmos-kit/core/esm/index.js
init_process();
init_buffer();
...
bowser/src/bowser.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WM45VYAB.js.map
